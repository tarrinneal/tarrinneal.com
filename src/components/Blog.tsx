...
export const Blog = () => (
  <div id='blog'>
    ...
    <p className='blogEntry'>
      ...
      with links to my portfolio items, the first signs of some css and webpage
      structure, and icon links to my github and linkedin.
      <br />
      <br />
      I'm still just trying to figure what I want this space to be. I certainly
      don't think blogging will end up being my big plan for it. I do have a
      short list of things I plan to add currently:
      <ul>
        <li>About Me</li>
        <li>Style</li>
        <li>Games</li>
    ...
    <p className='blogEntry'>
      ...
      Typescript with React, but I think the main issue was caused by me using a
